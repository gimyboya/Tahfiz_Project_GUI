...
public class Section {
	...
	private int min_amount_of_hifz;
	private int min_amount_of_moragah;
	...
	public Section(String name, int section_number, int number_of_student, int range_age_from, int range_age_to,
			int min_amount_of_hifz, int min_amount_of_moragah, String time, Teacher facilator, Child[] students_in_section) {
